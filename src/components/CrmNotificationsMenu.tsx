      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 w-80 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-900">
          <div className="border-b border-slate-100 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-800/50">
            <h3 className="font-bold text-slate-800 dark:text-white">Notificações do CRM</h3>
          </div>
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((notification) => (
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">{notification.content}</p>
                </div>
              ))
            )}
          </div>
