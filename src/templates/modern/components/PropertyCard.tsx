...
import { BedDouble, Car, ChevronLeft, ChevronRight, Home as HomeIcon, MapPin, Maximize2 } from 'lucide-react';
import { useTenant } from '../../../contexts/TenantContext';
import { Property } from '../../../types';
import { getPrimaryColor, getSecondaryColor } from '../tenantUtils';
...
const PropertyCard: React.FC<PropertyCardProps> = ({ property }) => {
  ...
  const secondaryColor = getSecondaryColor(tenant);
  ...
  const linkTo = `/imovel/${property.slug || property.id}`;
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-grow">
        <h3 className="font-bold text-lg text-slate-800 line-clamp-1 transition-colors mb-1 group-hover:opacity-80">
          {property.title}
        </h3>
